  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 font-sans">
        ...
        {/* Categories */}
        <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-14 md:py-20 max-w-6xl">
          <div className="space-y-12 md:space-y-20">
            {Object.entries(entriesByCategory).map(([category, items], categoryIndex) => (
              ...
              >
                {/* Category Header */}
                <div className="mb-6 md:mb-10 pb-4 md:pb-6 border-b border-dashed border-border">
                  <div className="flex items-baseline justify-between flex-wrap gap-2 md:gap-3">
                ...
                <div className="space-y-1">
                  {items.map((entry, index) => (
                    ...
                    >
                      <article className="py-4 sm:py-5 md:py-6 px-3 sm:px-4 md:px-6 border-l-2 border-transparent hover:border-primary hover:bg-muted/30 rounded-r">
                        <div className="flex items-start justify-between gap-2 sm:gap-4">
                          <div className="flex-1 space-y-1 sm:space-y-2 min-w-0">
                            <div className="flex items-baseline gap-2 sm:gap-3">
                              <span className="text-[10px] sm:text-xs text-muted-foreground font-medium font-mono min-w-[1.5rem] sm:min-w-[2rem]">
                                {String(index + 1).padStart(2, '0')}
                              </span>
                              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold group-hover:text-primary transition-colors">
                                {entry.term}
                              </h3>
                            </div>
                            <p className="text-xs sm:text-sm md:text-base text-muted-foreground leading-relaxed ml-6 sm:ml-8 md:ml-11 line-clamp-2">
                              {entry.shortDefinition}
                            </p>
                          </div>
                          <div className="entry-arrow flex-shrink-0 mt-1 sm:mt-2">
                            <svg
        ...
        <div className="border-t border-border bg-gradient-to-b from-muted/20 to-background">
          <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16 max-w-4xl text-center">
            <div className="space-y-4 md:space-y-6">
              ...
              <Link
                href="/auth/signup"
                className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-primary text-primary-foreground text-sm sm:text-base font-medium rounded-lg hover:bg-primary/90 transition-colors shadow-sm"
              >
                Kostenlos starten
              </Link>
            </div>
