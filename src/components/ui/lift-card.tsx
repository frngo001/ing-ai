...
const cardVariants = cva(
  [
    ...
    "relative justify-between border border-border/40 bg-card",
  ],
  {
    variants: {
      variant: {
  ...
  return (
    <Image
      ...
      className={cn(
        ...
        "-mt-6 mx-0 mb-0 h-[160px]",
        "md:-mt-[calc(1.5rem+1px)] md:-mx-[calc(1.5rem+1px)] md:mb-0 md:h-[200px] md:w-[calc(100%+3rem+2px)] md:max-w-[100vw]",
        "rounded-t-[var(--radius)] transition-transform duration-[250ms] ease-in-out",
        className
      )}
